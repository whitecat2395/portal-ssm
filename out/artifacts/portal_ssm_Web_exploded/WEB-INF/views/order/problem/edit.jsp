...
<body>
    ...
    <%--  <a href="">首页</a>--%>
      <a href="order/todo/list">故障上报</a>
      <a > 更改故障</a>
    </span>
    <form class="layui-form" lay-filter="form" action="order/problem/edit" method="post">
            ...
            <div class="layui-input-block">
                <select class="layui-select" name="equipmentId"
                    ...
                    <c:forEach items="${equipmentList}" var="item">
                        ...
                        <option value="${item.id}" ${formData.equipmentId==item.id?'selected':''}>${item.name}</option>
            ...
            <div class="layui-input-block">
                ...
                >
                    ...
                    <c:forEach items="${userList}" var="item">
                            <option value="${item.id}" ${formData.targetUserId == item.id?'selected':''}>${item.username}</option>
