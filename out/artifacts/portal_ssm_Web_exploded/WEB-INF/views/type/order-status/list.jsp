...
<body>
    <span class="layui-breadcrumb">
      <a href="order-status/list">工单状态管理</a>
      <a href="">工单状态列表</a>
    </span>
        ...
        <form class="layui-form" id="form">
            ...
            <div class="layui-inline">
                ...
                <shiro:hasPermission name="permission:insert">
                    <a href="order-status/add/page" class="layui-btn ">新增</a>
                </shiro:hasPermission>
            </div>
        </form>
    </script>
    <script type="text/html" id="tool">
        <shiro:hasPermission name="permission:update">
            <a href="order-status/edit/page?id={{d.id}}" class="layui-btn layui-btn-warm layui-btn-xs" >修改</a>
        </shiro:hasPermission>
            ...
            table.on('tool(table)',function(obj){
                ...
                if(obj.event == 'delete'){
                    ...
                    layer.confirm('正在删除当前数据是否继续?',{
                        ...
                        location.href = 'order-status/delete?id='+id
                        layer.close(index)
                    })
                }
            })
