...
<body>
    <span class="layui-breadcrumb">
      <a href="equipment-status/list">设备状态维护</a>
      <a href="">设备状态列表</a>
    </span>
    ...
    <script id="query-form" type="text/html">
        <form class="layui-form" id="form">
            <div class="layui-inline">
                <label class="layui-form-label" style="width: auto">状态名称</label>
                <div class="layui-input-inline">
                    <input class="layui-input"
                           name="statusName" type="text" placeholder="请输入状态名称"
                           value="{{d.where.statusName}}"
                    />
                </div>
            </div>
            <div class="layui-inline">
                ...
                <shiro:hasPermission name="permission:insert">
                    <a href="equipment-status/add/page" class="layui-btn ">新增</a>
                </shiro:hasPermission>
            </div>
        </form>
    </script>
    <script type="text/html" id="tool">
        <shiro:hasPermission name="permission:update">
            <a href="equipment-status/edit/page?id={{d.id}}" class="layui-btn layui-btn-warm layui-btn-xs" >修改</a>
        </shiro:hasPermission>
    ...
    <script type="text/javascript">
        layui.use('table',function(){
            ...
            table.init('table',{
                ...
                // ],
                page:true,
                url:'equipment-status/list/page',
                response: {
                    statusCode: 200
                },
                request: {
            ...
            table.on('tool(table)',function(obj){
                ...
                if(obj.event == 'delete'){
                    ...
                    layer.confirm('正在删除当前数据是否继续?',{
                        ...
                        location.href = 'equipment-status/delete?id='+id
                        layer.close(index)
                    })
                }
            })
