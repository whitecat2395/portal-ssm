...
<body>
    <span class="layui-breadcrumb">
      <a href="room-area/list">机房区域维护</a>
      <a href="">机房区域列表</a>
    </span>
    ...
    <script id="query-form" type="text/html">
        <form class="layui-form" id="form">
            <div class="layui-inline">
                <label class="layui-form-label" style="width: auto">区域名称</label>
                <div class="layui-input-inline">
                    <input class="layui-input"
                           name="areaName" type="text" placeholder="请输入区域名称"
                           value="{{d.where.areaName}}"
                    />
                </div>
            </div>
            <div class="layui-inline">
                ...
                <shiro:hasPermission name="permission:insert">
                    <a href="room-area/add/page" class="layui-btn ">新增</a>
                </shiro:hasPermission>
            </div>
        </form>
    </script>
    <script type="text/html" id="tool">
        <shiro:hasPermission name="permission:update">
            <a href="room-area/edit/page?id={{d.id}}" class="layui-btn layui-btn-warm layui-btn-xs" >修改</a>
        </shiro:hasPermission>
            ...
            table.on('tool(table)',function(obj){
                ...
                if(obj.event == 'delete'){
                    ...
                    layer.confirm('正在删除当前数据是否继续?',{
                        ...
                        location.href = 'room-area/delete?id='+id
                        layer.close(index)
                    })
                }
            })
